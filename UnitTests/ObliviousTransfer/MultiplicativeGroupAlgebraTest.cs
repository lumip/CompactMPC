...
namespace CompactMPC.UnitTests.ObliviousTransfer
{
    ...
    public class MultiplicativeGroupAlgebraTest
    {
        ...
        {
            MultiplicativeGroupAlgebra groupAlgebra = new MultiplicativeGroupAlgebra(new SecurityParameters(11, 5, 3, 1, 1));
            ...
            groupAlgebra = new MultiplicativeGroupAlgebra(new SecurityParameters(11, 10, 2, 1, 1));
